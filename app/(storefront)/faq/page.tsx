    ...
    <>
      ...
      <main className="content">
        <div className="wrap faq-wrap">
          <h2 className="faq-cat" id="commande">Commande &amp; paiement</h2>
          ...
          <h2 className="faq-cat" id="livraison">Livraison</h2>
          ...
          <h2 className="faq-cat" id="dimensions">Dimensions &amp; choix</h2>
          ...
          <h2 className="faq-cat" id="montage">Montage</h2>
          ...
          <h2 className="faq-cat" id="garantie">Garantie &amp; retours</h2>
