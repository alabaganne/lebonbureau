...
const baseClasses =
  "inline-flex items-center justify-center text-center gap-[10px] border rounded-full px-6 py-[13px] font-semibold text-[15px] tracking-[.01em] whitespace-nowrap transition-[transform,background,color,border-color] duration-200 ease-out active:translate-y-px";

const variantClasses: Record<Variant, string> = {
  primary: "border-green bg-green text-white hover:border-green-deep hover:bg-green-deep",
  dark: "border-ink bg-ink text-white hover:border-black hover:bg-black",
  ghost: "border-line bg-transparent text-ink hover:border-ink",
  light: "border-white bg-white text-green-deep hover:border-sand hover:bg-sand",
};
